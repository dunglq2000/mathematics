...
### 7. Secure Matrix Transmissions v2
...
$$\left(\dfrac{c_i}{c_0}\right)^n = \dfrac{U_{i0}}{U_{00}} \cdot \dfrac{W_{00}}{W_{i0}} \pmod p, \quad 1 \leqslant i \leqslant 5$$

Tương tự cho $d_i$ ta có

$$\left(\dfrac{d_i}{d_0}\right)^m = \dfrac{U_{0i}}{U_{00}} \cdot \dfrac{W_{00}}{W_{0i}} \pmod p, \quad 1 \leqslant i \leqslant 5$$
